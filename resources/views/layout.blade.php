@php
        ...
        $admin_info=DB::table('admin_table')
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{url('admin_dashboard')}}"><h2 style="font-family:cursive; font-size:20px;">Std Enrolment System</h2></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            <div class="profile">
            <img src="{{url($admin_info->admin_img)}}" height="50" width="60" style="border-radius:50%"></td>
            </div>
            <div class="details">
              <p class="user-name">{{$admin_info->admin_name}}</p>
              <p class="designation">{{$admin_info->admin_phone}}</p>
            </div>
          </div>
          <ul class="nav">
            <!--main pages start-->
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('CSE_students')}}">CSE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('EEE_students')}}">EEE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('BBA_students')}}">BBA</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('Civil_students')}}">Civil</a>
                  </li>
                </ul>
              </div>
            </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="advancedSubmenu">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('View_Teachers')}}">View Teachers</a>
                  </li>
                </ul>
              </div>
            </li>         
