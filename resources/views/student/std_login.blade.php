        ...
        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth-pages">
          <div class="card col-lg-4 mx-auto">
            <div class="card-body px-5 py-5">
              <h3 class="card-title text-center mb-3">Student Login</h3>
              ...
              {{csrf_field()}}
                <div class="form-group">
                  <label>Email *</label>
                  <input type="text" class="form-control p_input" name="std_email" placeholder="Enter your Email">
                </div>
                <div class="form-group">
                  <label>Password *</label>
                  <input type="text" class="form-control p_input" name="std_password" placeholder="Password">
                </div>
                ...
                <div class="d-flex justify-content-center mb-4">
                  <a href="{{url('Student_Register')}}" class="google-login btn btn-google">Register Now</a>
                </div>
